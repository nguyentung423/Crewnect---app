...
export default function Jobs() {
  const [jobs, setJobs] = useState([
    ...
    },
    {
      ...
      urgency: "medium",
      featured: false,
      requirements: ["Cao trên 1m6", "Năng động", "Không sợ đông người"],
    },
    {
      id: 3,
      title: "PB Roadshow Samsung",
      company: "Marketing Hub",
      location: "Các TTTM Hà Nội",
      type: "Part-time",
      ...
      urgency: "low",
      featured: false,
      requirements: ["Biết tiếng Anh cơ bản", "Kinh nghiệm bán hàng", "Năng động"],
    },
  ]);
  ...
  className="bg-gradient-to-r from-green-800 to-green-700 hover:from-green-900 hover:to-green-800 
             text-white font-semibold px-6 py-3 rounded-xl shadow-lg shadow-green-800/25 
  ...
  Đăng job mới
      ...
      <div className="grid gap-6">
        {filteredJobs.map((job) => (
          <div
            key={job.id}
            className={`bg-white rounded-xl shadow-sm border-l-4 border border-slate-200 p-6 hover:shadow-md transition-shadow duration-200 ${urgencyColors[job.urgency]}`}
          >
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              ...
              <div className="flex lg:flex-col items-center lg:items-end gap-4">
                <div className="text-center lg:text-right space-y-1">
                  <div className="text-2xl font-bold text-slate-800">{job.applicants}</div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="p-2 text-amber-600 hover:bg-amber-50 rounded-lg transition-colors group">
